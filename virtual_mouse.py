...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		cv2.line(image, (finger_tip_x, finger_tip_y),(thumb_tip_x, thumb_tip_y),(0,0,0),2)
		...
		print("Tamanho de Tela do Computador:",screen_width, screen_height, "Tamanho da Janela de Resultado: ", width, height)
		print("Posicao da Poses: ", mouse.position, "Posicao Central da Linha das Pontas: ", center_x, center_y)
